...
<body>
	<table class="table">
		...
		<tr>
			<td align='center' ><?php echo $val['v_id'];?></td>
			<td align='center' ><?php echo $val['v_title'];?></td>
			<td align='center' ><?php echo $val['v_desc'];?></td>
			<td align='center' ><img src="/bbs/video/<?php echo $val['v_image'];?>" width="50" height="50" border="0" alt=""></td>
			<td align='center' ><?php echo $val['addtime'];?></td>
			<td align='center' >
				<a href="">[修改]</a>
				<a href="/bbs/admin.php/Home/Index/video_del/id/<?php echo $val['id'];?>" class="del">[删除]</a>
			</td>
		</tr>
		<?php }?>
	</table>
