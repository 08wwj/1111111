...
<body>
	<form action="/bbs/admin.php/Home/Index/add_video_pro" enctype="multipart/form-data" method="post" >
		<table class="table">
			<tr>
			...
			<tr>
				<td>视频标签</td>
				<td>
					<input type="text" name="v_link" class="v_title"/>
				</td>
			</tr>
			<tr>
				<td>视频描述</td>
				<td>
					<textarea id="editor_id" name="v_desc" style="width:700px;height:300px;"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2">
