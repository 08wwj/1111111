...
<div id="box">
  ...
  <div id="left" class="fl" style="margin-top:8px;">
    <div class="infotop"><img src="/bbs/Public/images/infotop.gif"/></div>
    <div class="left_content1">
      <div id="printarea">
        <h1 class="infotitle">罗弟华老师精彩视频  ①当当网-用户注册验证</h1>
        <div class="editer">更新时间:2013年04月02日13时53分 来源:</div>
        <div class="infor">
        <?php foreach($list as $k=>$v) { ?>
        <p style="text-indent:0em;"><img alt="" src="/bbs/Public/<?php echo $v['s_image'];?>" style="float:left;margin-right:15px;height:189px;width:155px;" /><span style="font-size:12px;"><span class="blue" style=""><strong><?php echo $v['s_name'];?></strong></span><br />
            <strong>职 务：<?php echo $v['z_name'];?></strong><br />
&nbsp; &nbsp; <?php echo $v['s_content'];?></span></p>
<hr />
<?php } ?>
<p></p>
