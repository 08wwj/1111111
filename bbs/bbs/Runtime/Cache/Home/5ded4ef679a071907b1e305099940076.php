...
.kcnr-table{ line-height:20px;}
	.kcnr-table li{ list-style-image:url(/bbs/Public/images/20120718144154342.jpg); margin-left:15px;;</style>
</div>
<ol>
    <?php foreach($list as $k=>$v){?>
    
<li class="fl" style="width:141px;"><img src="/bbs/Public/<?php echo $v['p_image'];?>" width="100" height="100"></li>
