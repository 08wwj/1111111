...
<li><a href="/bbs/index.php/Home/Question1/qq/id/<?php echo $v['q_id']?>" target="_blank"><?php echo $v['q_wenti']?></a> <?php echo $v['q_time']?></li>
<?php } ?>
</ul>
...
<li><a href="/bbs/index.php/Home/Question1/qq/id/<?php echo $v['q_id']?>" target="_blank"><?php echo $v1['q_wenti'];?></a><?php echo $v1['q_time']?></li>
<?php } ?>
</ul>
