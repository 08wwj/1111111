...
<body>
	<table class="table">
		<tr>
			<td class="th" colspan="10">查看视频分类</td>
		</tr>
		<tr>
			<th>CID</th>
			<th>分类名称</th>
		...
		<tr>
			...
			<td>
				<a href="<?php echo U('Home/index/edit_category_video');?>?c_id=<?php echo $val['c_id']?>">[编辑]</a>
                                <a href="<?php echo U('Home/index/category_video_delete');?>?c_id=<?php echo $val['c_id']?>" class="del">[删除]</a>
			</td>
		</tr>
		<?php }?>
	</table>
