		...
		<table class="table">
			...
			<tr>
                        ...
                        <tr>
                            <td>教师头像</td>
                            <td>
                                <input type="file" name="s_image" class="title"/><img src="./upload/<?php echo $v['s_image'];?>"/>
                            </td>
			</tr>
			<tr>
                            <td>栏目</td>
			...
			<tr>
                            <td>描述</td>
                            <td>
                                    <textarea id="editor_id" name="s_content" style="width:700px;height:300px;"><?php echo $val['s_content']?></textarea>
                            </td>
			</tr>
                        <tr>
                            <td>是否显示</td>
